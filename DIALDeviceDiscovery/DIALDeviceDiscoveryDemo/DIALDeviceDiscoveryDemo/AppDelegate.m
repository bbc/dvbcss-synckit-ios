...
// Notification for the view controllers to refresh of their list of discovered devices
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MWLogInfo(@"AppDelegate: Loading DIAL device discovery components .... ");
...
- (void) DIALServiceDiscoveryNotifcationReceived:(NSNotification*) aNotification
{
    ...
    } else if ([[aNotification name] caseInsensitiveCompare:kDIALDeviceExpiryNotification] == 0)
    {
        ...
        // gracefully degrade service to no-sync
        // 1. notify UI about this event
        // 2. unload CIIProtoClient, WCProtoClient, TSClient components
        //...
    }
}
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "uk.co.bbc.rd.DIALDeviceDiscoveryDemo" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"DIALDeviceDiscoveryDemo" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"DIALDeviceDiscoveryDemo.sqlite"];
    NSError *error = nil;
