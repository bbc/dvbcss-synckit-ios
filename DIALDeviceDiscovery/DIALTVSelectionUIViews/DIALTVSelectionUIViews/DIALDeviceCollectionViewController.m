...
#import <SyncKitDelegate/SyncKitDelegate.h>
...
@implementation DIALDeviceCollectionViewController
{
    ...
    SynckitConfigurator *syncKitDelegate;
...
- (id) initWithDevicesSource:(DIALServiceDiscovery*) dialDiscovery
{
    self = [super init];
    
    if (self != nil) {
        
        _tvDiscoveryComponent = dialDiscovery;
...
- (void)viewDidLoad {
    ...
    if(!_tvDiscoveryComponent){
        ...
        syncKitDelegate = [SynckitConfigurator getInstance];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)cv cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setImage:[UIImage imageNamed:@"DIALTV_UI_ResourceBundle.bundle/tv_flat_180x180.png"]];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MWLogDebug(@"%@ master device selected:", selectedDIALDevice.friendlyName);
